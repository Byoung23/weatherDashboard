$(document).ready(function () {
    ...
    //display data stored in locale storage in previous search div
    ...
    $(document).on("click", ".test", function () {
        ...
        // grab value of buttons created by pulling data from locale storage and run the ajax call to load the current and 5 forecast data
        var btnValue = $(this).text();

        console.log("btnValue" + btnValue);

        //take the button value in order to retrieve data
        var apiKey = "c5d938973bdc5719520478ee24918737";
